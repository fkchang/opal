...
$klass(this, nil, "BasicObject", function() {var $const = this.$const, $proto = this.$proto; 
  $defn(this, 'm$initialize', function($yield) {var $arity = arguments.length; if ($arity !== 0) { $arity -= 1; }if ($arity !== 0) { $opal.arg_error($arity, 0); }
    return nil;});

  $defn(this, 'm$eq$', function($yield, other) {var $arity = arguments.length; if ($arity !== 0) { $arity -= 1; }if ($arity !== 1) { $opal.arg_error($arity, 1); }

    return this === other;});

  $defn(this, 'm$__send__', function($yield, symbol, args) {var $arity = arguments.length; if ($arity !== 0) { $arity -= 1; }if ($arity < 1) { $opal.arg_error($arity, -2); }var $block_given = ($yield != null); var block = $yield || ($yield = $no_proc, nil);var $context = $yield.$S;args = $slice.call(arguments, 2);
  ...
  $defn(this, 'm$instance_eval', function($yield, string) {var $arity = arguments.length; if ($arity !== 0) { $arity -= 1; }if ($arity < 0) { $opal.arg_error($arity, -1); }var $block_given = ($yield != null); var block = $yield || ($yield = $no_proc, nil);var $context = $yield.$S;if (string === undefined) { string = nil; }
  ...
  $defn(this, 'm$instance_exec', function($yield, args) {var $arity = arguments.length; if ($arity !== 0) { $arity -= 1; }if ($arity < 0) { $opal.arg_error($arity, -1); }var $block_given = ($yield != null); var block = $yield || ($yield = $no_proc, nil);var $context = $yield.$S;args = $slice.call(arguments, 1);
  ...
  $defn(this, 'm$method_missing', function($yield, symbol, args) {var _a; var $arity = arguments.length; if ($arity !== 0) { $arity -= 1; }if ($arity < 1) { $opal.arg_error($arity, -2); }args = $slice.call(arguments, 2);

    return raise(RubyNoMethodError, 'undefined method `' + symbol + '` for ' + ((_a=this).m$inspect || $opal.mm('m$inspect')).call(_a));});

  $defn(this, 'm$singleton_method_added', function($yield, symbol) {var $arity = arguments.length; if ($arity !== 0) { $arity -= 1; }if ($arity !== 1) { $opal.arg_error($arity, 1); }

    return nil;});

  $defn(this, 'm$singleton_method_removed', function($yield, symbol) {var $arity = arguments.length; if ($arity !== 0) { $arity -= 1; }if ($arity !== 1) { $opal.arg_error($arity, 1); }

    return nil;});

  return $defn(this, 'm$singleton_method_undefined', function($yield, symbol) {var $arity = arguments.length; if ($arity !== 0) { $arity -= 1; }if ($arity !== 1) { $opal.arg_error($arity, 1); }
...
$klass(this, nil, "Object", function() {var $const = this.$const, $proto = this.$proto; 
  ...
  ((_a=this).m$include || $opal.mm('m$include')).call(_a, null, $opal.const_get($const, "Kernel"));$defn(this, 'm$methods', function($yield) {var $arity = arguments.length; if ($arity !== 0) { $arity -= 1; }if ($arity !== 0) { $opal.arg_error($arity, 0); }
  ...
  $defn(this, 'm$singleton_methods', function($yield) {var _a; var $arity = arguments.length; if ($arity !== 0) { $arity -= 1; }if ($arity !== 0) { $opal.arg_error($arity, 0); }
  ...
  return $defn(this, 'm$to_native', function($yield) {var _a; var $arity = arguments.length; if ($arity !== 0) { $arity -= 1; }if ($arity !== 0) { $opal.arg_error($arity, 0); }

    return ((_a=this).m$raise || $opal.mm('m$raise')).call(_a, null, $opal.const_get($const, "TypeError"), "no specialized #to_native has been implemented");});
}, 0);
...
$klass(this, nil, "Native", function() {var $const = this.$const, $proto = this.$proto; 
  $klass(this, nil, "Object", function() {var $const = this.$const, $proto = this.$proto; 
    ...
    ((_a=this).m$include || $opal.mm('m$include')).call(_a, null, $opal.const_get($const, "Native"));$defn(this, 'm$aref$', function($yield, name) {this['native'] == null && (this['native'] = nil);var $arity = arguments.length; if ($arity !== 0) { $arity -= 1; }if ($arity !== 1) { $opal.arg_error($arity, 1); }

      return this['native'][name];});

    $defn(this, 'm$aset$', function($yield, name, value) {this['native'] == null && (this['native'] = nil);var $arity = arguments.length; if ($arity !== 0) { $arity -= 1; }if ($arity !== 2) { $opal.arg_error($arity, 2); }

      return this['native'][name] = value;});

    $defn(this, 'm$nil$p', function($yield) {this['native'] == null && (this['native'] = nil);var $arity = arguments.length; if ($arity !== 0) { $arity -= 1; }if ($arity !== 0) { $opal.arg_error($arity, 0); }

      return this['native'] === null || this['native'] === undefined;});

    return $defn(this, 'm$method_missing', function($yield, name, args) {var _a, _b; this['native'] == null && (this['native'] = nil);var $arity = arguments.length; if ($arity !== 0) { $arity -= 1; }if ($arity < 1) { $opal.arg_error($arity, -2); }args = $slice.call(arguments, 2);
  ...
  ((_a=this).m$alias_method || $opal.mm('m$alias_method')).call(_a, null, "__native_send__", "native_send");;$opal.donate(this, ["m$initialize", "m$to_native", "m$native_send"]);
}, 1);
...
$klass(this, nil, "Enumerable", function() {var $const = this.$const, $proto = this.$proto; 
  ...
  ((_a=this).m$alias_method || $opal.mm('m$alias_method')).call(_a, null, "to_a", "entries");;$opal.donate(this, ["m$all$p", "m$any$p", "m$collect", "m$count", "m$detect", "m$drop", "m$drop_while", "m$each_with_index", "m$entries", "m$find_index", "m$first", "m$grep"]);
}, 1);
...
$klass(this, nil, "Kernel", function() {var $const = this.$const, $proto = this.$proto; 
  ...
  ((_a=this).m$alias_method || $opal.mm('m$alias_method')).call(_a, null, "to_enum", "enum_for");;$opal.donate(this, ["m$enum_for"]);
}, 1);
...
$klass(this, nil, "Struct", function() {var $const = this.$const, $proto = this.$proto; 
  $defs(this, 'm$new', function($yield, name, args) {var _a, _b; var $arity = arguments.length; if ($arity !== 0) { $arity -= 1; }if ($arity < 1) { $opal.arg_error($arity, -2); }args = $slice.call(arguments, 2);
    ...
    null, $opal.const_get($const, "Struct"))) !== false && _a !== nil) {} else {return $zuper(arguments.callee, this, [])};if ((_a = ((_b=name).m$is_a$p || $opal.mm('m$is_a$p')).call(_b, null, $opal.const_get($const, "String"))) !== false && _a !== nil) {
...
$klass(this, nil, "Time", function() {var $const = this.$const, $proto = this.$proto; 
  ...
  $proto.m$initialize = function($yield, year, month, day, hour, min, sec, utc_offset) {var _a; var $arity = arguments.length; if ($arity !== 0) { $arity -= 1; }if ($arity < 0) { $opal.arg_error($arity, -1); }if (year === undefined) { year = nil; }if (month === undefined) { month = nil; }if (day === undefined) { day = nil; }if (hour === undefined) { hour = nil; }if (min === undefined) { min = nil; }if (sec === undefined) { sec = nil; }if (utc_offset === undefined) { utc_offset = nil; }
    ...
    if ((_a = year) !== false && _a !== nil) {return $zuper(arguments.callee, this, [new Date(((_a=year).m$to_native || $opal.mm('m$to_native')).call(_a), ((_a=month).m$to_native || $opal.mm('m$to_native')).call(_a), ((_a=day).m$to_native || $opal.mm('m$to_native')).call(_a), ((_a=hour).m$to_native || $opal.mm('m$to_native')).call(_a), ((_a=min).m$to_native || $opal.mm('m$to_native')).call(_a), ((_a=sec).m$to_native || $opal.mm('m$to_native')).call(_a))])} else {return $zuper(arguments.callee, this, [new Date()])};};
